...
export function CheckSentimentsButton({ onClick }: CheckSentimentsButtonProps) {
  ...
  ? "w-80 h-12 text-base font-semibold rounded-full text-primary-foreground bg-gradient-to-r from-[hsl(var(--mint))] to-[hsl(var(--blue-accent))] transition-all duration-300 hover:opacity-90 hover:scale-105"
